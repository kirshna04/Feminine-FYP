...
const Dashboard = ({ component, setshowLeftSideBar, showLeftSideBar }) => {
  ...
  let ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzon50OBw7lo4WabzkwazOxyN_GzgubVoV_JwcvPCAnZlT79a7-xGuDFgJxo47zRR17o0&usqp=CAU"
    ...
    <div className='font-popins flex items-start w-screen h-screen overflow-y-auto absolute'>
      ...
      <div className='w-[13rem] hidden md:block h-[100%] bg-[#4f619f] pl-4 pr-4 pt-5 pb-10 relative'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <p className='text-white text-sm tracking-wider  font-popins font-bold '>Feminine <span className='text-orange-400'>Care</span></p>
        </div>
        ...
        <div className='mt-8'>
          ...
          <div>
            ...
            <h1 className='text-white text-base font-bold tracking-wider mb-2'>Menu</h1>

            <div onClick={() => nav("/admin/home")} className='hover:bg-[#5b6aa1] hover:text-white text-[#8e99c1] h-[2rem] mb-2 rounded-sm cursor-pointer flex justify-start gap-3 pl-2 items-center'>
              <MdDashboardCustomize className='' />
              <p className='text-sm cursor-pointer tracking-wide'>Dasboard</p>
            </div>

            <div onClick={() => nav("/admin/blogs")} className='hover:bg-[#5b6aa1] hover:text-white text-[#8e99c1] h-[2rem] mb-2 rounded-sm cursor-pointer flex justify-start gap-3 pl-2 items-center'>
              <BsBarChartFill className='' />
              <p className='text-sm cursor-pointer tracking-wide'>Blogs</p>
            </div>

            <div onClick={() => nav("/admin/videos")} className='hover:bg-[#5b6aa1] hover:text-white text-[#8e99c1] h-[2rem] mb-2 rounded-sm cursor-pointer flex justify-start gap-3 pl-2 items-center'>
              <TbDiscount className='' />
              <p className=' text-sm cursor-pointer tracking-wide'>Videos</p>
            </div>
          ...
          <div className='mt-4'>
            ...
            <div>
              <h1 className='text-white text-base font-bold tracking-wider mb-2'>Management</h1>
          ...
          <div className='mt-4'>
            ...
            <div>
              <h1 className='text-white text-base font-bold tracking-wider mb-2'>Notification</h1>
              <div className='hover:bg-[#5b6aa1] hover:text-white text-[#8e99c1] h-[2rem] mb-2 rounded-sm cursor-pointer flex justify-start gap-3 pl-2 items-center'>
        ...
        <div className='mt-4 flex justify-center items-center  absolute bottom-4 w-[83%]'>
          ...
          <div className='flex justify-between items-center flex-1 bg-[#ff7556] h-[3rem] rounded-md shadow-otpShadow cursor-pointer p-1'>
            ...
            <div className='flex gap-2'>
              <div>
                <img className='w-[2rem] h-[2rem] bg-center rounded-full' src={ImageUrl} alt="" />
              </div>
              <div>
          ...
          <div className='w-[13rem] block md:hidden h-[100%] bg-[#4f619f] pl-4 pr-4 pt-5 pb-10 absolute top-0 left-0 z-50'>
            ...
            <div className='flex justify-center items-center  absolute bottom-2 w-[83%]'>
              ...
              <div className='flex justify-between items-center flex-1 bg-[#ff7556] h-[3rem] rounded-md shadow-otpShadow cursor-pointer p-1'>
                ...
                <div className='flex gap-2'>
                  <div>
                    <img className='w-[2rem] h-[2rem] bg-center rounded-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzon50OBw7lo4WabzkwazOxyN_GzgubVoV_JwcvPCAnZlT79a7-xGuDFgJxo47zRR17o0&usqp=CAU" alt="" />
                  </div>
                  <div>
                    <p className='text-xs text-white'>Wole Michoel</p>
                    <p className='text-xs text-white'>Seller</p>
