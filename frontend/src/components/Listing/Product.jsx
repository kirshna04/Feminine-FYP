...
const Product = ({ title, isMargin, data, Loading }) => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const offsetWidth = scrollerRef?.current?.offsetWidth;

      if (scrollLeft + offsetWidth >= scrollerRef?.current?.scrollWidth) {
    ...
    <div className="p-5 mt-10 -z-50">
      ...
      {isLoading ? (
        ...
        <div className="flex justify-center items-center">
          <div
            className={`flex gap-10 justify-between items-center overflow-x-hidden ${
              isMargin ? "mb-[5rem]" : null
            } sm:mb-0`}
            ref={scrollerRef}
          >
            {data?.map((item, index) => {
              return (
                <div
                  ...
                  className="w-[16rem] min-w-[16rem] cursor-pointer h-fit bg-white relative rounded-lg shadow-productShadow"
                >
                  {/* IMAGE  */}
                  <div className="flex justify-center items-center mt-0 mb-2">
                    <img
                      ...
                      src={item.images[0]}
                      alt=""
                      className=" w-[100%] h-[10rem] rounded-tr-md rounded-tl-md"
                    />
                  </div>
                  ...
                  <div className="pl-2 pr-2">
                    ...
                    <p className="text-sm text-slate-600 mb-1 custom-ellipsis">
                      {item.description}
                    </p>
                  ...
                  <div className="pl-2 pr-2 mt-4 absolute bottom-2 w-[100%]">
                    <Button
                      text={"Add To Cart"}
